export default class Gameover2 extends Phaser.Scene {
    constructor() {
      super("Gameover2"); // Nombre de la escena, debe coincidir con el proporcionado en la configuración
    }
    ...
    create() {
      ...
      this.add.image(600, 500, "reintentar").setInteractive().on("pointerdown", () => this.scene.start("Level2"));
